...
if(command === `${prefix}suck`){
  ...
  message.channel.send(`${message.author.username} puts that mouth to good use and gave `+ sayMessage + ` ${Preplies[Presult]}` + ` ${Treplies[Tresult]}` + " They seemed to have" + `${Ureplies[Uresult]}`);
}
