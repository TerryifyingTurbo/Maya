...
if(command ===`${prefix}fucc`){
  ...
  let Preplies = [];
  let Posreplies = [`***${sayMessage}*** *bends over for* ***${message.member.username}***`, 
                    `***${sayMessage}*** *goes on all fours for* ***${message.member.username}***`,
                    `***${sayMessage}*** *angles those hips of theirs up and spreads their legs far and wide for* ***${message.member.username}***`,
                    ` *Face down, ass up!* ***${sayMessage}'s behind*** *is claimed by* ***${message.member.username}***`,
                    `***${message.member.username}*** *gets aggressive and pins down* ***${sayMessage}*** *, taking complete control over them*`,
                    `***${message.member.username}*** *is quite kinky and teases* ***${sayMessage}*** *with foreplay*`];
